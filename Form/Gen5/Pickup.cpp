...
Pickup::Pickup(QWidget *parent) : QWidget(parent), ui(new Ui::Pickup)
{
    ...
    connect(advanceFinder, &QAction::triggered, this, &Pickup::openAdvanceFinder);
    ...
    connect(adjacentSeeds, &QAction::triggered, this, &Pickup::openAdjacentSeeds);
