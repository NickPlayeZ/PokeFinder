...
public:
     ...
     * @param delay Delay
     */
    SeedTimeCalibrate4(const DateTime &dateTime, u32 delay);
     ...
     */
    SeedTimeCalibrate4(const DateTime &dateTime, u32 delay, u8 playerRoute, const std::array<bool, 3> &roamers,
